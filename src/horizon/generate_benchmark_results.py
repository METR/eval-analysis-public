...
def main(
    ...
    BENCHMARK_NAME = "METR-Horizon-v1"
    # Commit hashes for the task manifest files, hardcoded for now
    BENCHMARK_LONG_TASKS_VERSION = "2ce7f1e0c4f8b7f2653e7014941a1a9f3ca908e2"
    BENCHMARK_SWAA_VERSION = "3d2ab4f0662a752409858a73e006af35e3fb7d64"
